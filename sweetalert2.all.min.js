! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() {
    ...
    var $t = {},
        ...
        ee = Object.freeze({
            ...
            clickConfirm: Vt,
            clickCancel: function() { return S() && S().click() },
            getContainer: Y,
            getPopup: Z,
            getTitle: C,
            getContent: k,
    ...
    var ae = function() { navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || Z().scrollHeight > window.innerHeight - 44 && (Y().style.paddingBottom = "".concat(44, "px")) },
        ce = function() {
            var e, t = Y();
    ...
    function de(t) {
        ...
        i && (e = Pt.innerParams.get(this)) && !R(i, e.hideClass.popup) && (n = ue.swalPromiseResolve.get(this), ft(i, e.showClass.popup), pt(i, e.hideClass.popup), o = Y(), ft(o, e.showClass.backdrop), pt(o, e.hideClass.backdrop), function(t, e, n) {
            ...
            if (i) { pe(t, e, o, a) } else { le(t, o, Q(), a) }
        }(this, i, e), void 0 !== t ? (t.isDismissed = void 0 !== t.dismiss, t.isConfirmed = void 0 === t.dismiss) : t = { isDismissed: !0, isConfirmed: !1 }, n(t || {}))
    }
    var pe = function(t, e, n, o) { $t.swalCloseEventFinishedCallback = le.bind(null, t, n, Q(), o), e.addEventListener(wt, function(t) { t.target === e && ($t.swalCloseEventFinishedCallback(), delete $t.swalCloseEventFinishedCallback) }) },
    ...
    function ye(t) {
        var e = Y(),
            n = Z();
        "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Te(e, n, t), Ee(e, n), I() && Oe(e, t.scrollbarPadding), Q() || $t.previousActiveElement || ($t.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() { return t.onOpen(n) }), ft(e, W["no-transition"])
    }
    ...
    function Se(t, e, n) { Pt.innerParams.get(t).toast ? Ye(t, e, n) : (Qe(e), $e(e), Je(t, e, n)) }
    var Ee = function(t, e) { wt && rt(e) ? (t.style.overflowY = "hidden", e.addEventListener(wt, we)) : t.style.overflowY = "auto" },
        Oe = function(t, e) {
            var n;
        ...
        Ie = function(e, n) {
            function o(t) { return Ve[n.input](i, Re(t), n) }
            var i = k();
    ...
    var en, nn = function(t) { for (var e in t) t[e] = new WeakMap },
        on = Object.freeze({
            hideLoading: ne,
            disableLoading: ne,
            getInput: function(t) {
            ...
            closeModal: de,
            closeToast: de,
            enableButtons: function() { me(this, ["confirmButton", "cancelButton"], !1) },
            disableButtons: function() { me(this, ["confirmButton", "cancelButton"], !0) },
            enableInput: function() { return he(this.getInput(), !1) },
            disableInput: function() { return he(this.getInput(), !0) },
            ...
            _main: function(t) {
                ...
                var n = function(t) { var e = { popup: Z(), container: Y(), content: k(), actions: E(), confirmButton: B(), cancelButton: S(), closeButton: j(), validationMessage: A(), progressSteps: P() }; return Pt.domCache.set(t, e), e }(this);
            ...
            update: function(e) {
                ...
                var o = {};
                Object.keys(e).forEach(function(t) { an.isUpdatableParameter(t) ? o[t] = e[t] : N('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js')) });
                var i = s({}, n, o);
    ...
    s(rn.prototype, on), s(rn, ee), Object.keys(on).forEach(function(t) { rn[t] = function() { if (en) return en[t].apply(en, arguments) } }), rn.DismissReason = z, rn.version = "9.14.2";
    var an = rn;
